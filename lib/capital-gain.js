...
class CapitalGain {
  constructor(qty, bDate, bPrice, sDate, sPrice, ixPrice, desc) {
    this.quantity = qty;
    this.buyDate = bDate;
    ...
    const shouldUseIxPrice = isLongTermTrade && this.ixPrice && bDate.diff(ixPriceDate, "days") <= 0 && sDate.diff(ixPriceDate, "days") > 0;
